...
/**
 * Servlet implementation class PrikazDiskDetaljiSuper
 */
@WebServlet("/PrikazDiskDetaljiSuper")
public class PrikazDiskDetaljiSuper extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrikazDiskDetaljiSuper() {
        super();
