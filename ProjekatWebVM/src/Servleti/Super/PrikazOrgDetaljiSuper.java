...
/**
 * Servlet implementation class PrikazOrgDetaljiSuper
 */
@WebServlet("/PrikazOrgDetaljiSuper")
public class PrikazOrgDetaljiSuper extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrikazOrgDetaljiSuper() {
        super();
