...
/**
 * Servlet implementation class PrikazKatDetalji
 */
@WebServlet("/PrikazKatDetalji")
public class PrikazKatDetalji extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrikazKatDetalji() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("		<p>Broj jezgara: </p><input type=\"text\" name=\"brjezgra\" value=\""+k.kategorije.get(request.getParameter("ime")).getBroj_jezgara()+"\"/ >");
		out.println("		<p>RAM: </p><input type=\"text\" name=\"ram\" value=\""+k.kategorije.get(request.getParameter("ime")).getRam()+"\"/ >");
		out.println("		<p>GPU: </p><input type=\"text\" name=\"gpu\" value=\""+k.kategorije.get(request.getParameter("ime")).getGpu_jezgra()+"\"/ >");
		out.println("		<br>");
