...
/**
 * Servlet implementation class PrikazKorDetaljiSuper
 */
@WebServlet("/PrikazKorDetaljiSuper")
public class PrikazKorDetaljiSuper extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrikazKorDetaljiSuper() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Klase.Podaci k = (Klase.Podaci)getServletContext().getAttribute("podaci");
			...
			out.println("	</form>");
			out.println("<a href=ObrisiKorSuper?email="+request.getParameter("email")+">Obrisi korisnika</a>");
			out.println("</div></div>");
			out.println("</body>");
			out.println("</html>");
			out.flush();
