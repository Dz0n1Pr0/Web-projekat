...
/**
 * Servlet implementation class PrikazOrgDetaljiSuperKrajGreska
 */
@WebServlet("/PrikazOrgDetaljiSuperKrajGreska")
public class PrikazOrgDetaljiSuperKrajGreska extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrikazOrgDetaljiSuperKrajGreska() {
        super();
