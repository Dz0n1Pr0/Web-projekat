...
/**
 * Servlet implementation class DodajKorSuperKrajGreska
 */
@WebServlet("/DodajKorSuperKrajGreska")
public class DodajKorSuperKrajGreska extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DodajKorSuperKrajGreska() {
        super();
