...
/**
 * Servlet implementation class PrikazVMDetaljiSuperKrajGreska
 */
@WebServlet("/PrikazVMDetaljiSuperKrajGreska")
public class PrikazVMDetaljiSuperKrajGreska extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrikazVMDetaljiSuperKrajGreska() {
        super();
