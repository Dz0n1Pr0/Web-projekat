...
/**
 * Servlet implementation class DodajOrgKrajGreska
 */
@WebServlet("/DodajOrgKrajGreska")
public class DodajOrgKrajGreska extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DodajOrgKrajGreska() {
        super();
