...
/**
 * Servlet implementation class DodajVMSuperKrajGreska
 */
@WebServlet("/DodajVMSuperKrajGreska")
public class DodajVMSuperKrajGreska extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DodajVMSuperKrajGreska() {
        super();
