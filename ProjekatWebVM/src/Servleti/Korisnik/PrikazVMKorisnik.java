		...
		if(!(""+ request.getParameter("ime")).equals("null")){
			...
			if(dodaj)
			  ...
			  out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\">");
				...
				out.println("		<p>Email: </p><input type=\"text\" name=\"ramOd\" /> - <input type=\"text\" name=\"ramDo\" />");
				out.println("		<p>Password: </p><input type=\"text\" name=\"gpuOd\" /> - <input type=\"text\" name=\"gpuDo\" />");
				out.println("		<br>");
