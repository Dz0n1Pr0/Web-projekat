...
/**
 * Servlet implementation class PrikazVMDetaljiAdminKrajGreska
 */
@WebServlet("/PrikazVMDetaljiAdminKrajGreska")
public class PrikazVMDetaljiAdminKrajGreska extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrikazVMDetaljiAdminKrajGreska() {
        super();
