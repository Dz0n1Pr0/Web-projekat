...
/**
 * Servlet implementation class PrikazDiskDetaljiAdmin
 */
@WebServlet("/PrikazDiskDetaljiAdmin")
public class PrikazDiskDetaljiAdmin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrikazDiskDetaljiAdmin() {
        super();
