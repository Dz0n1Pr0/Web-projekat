...
/**
 * Servlet implementation class DodajVMAdminKrajGreska
 */
@WebServlet("/DodajVMAdminKrajGreska")
public class DodajVMAdminKrajGreska extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DodajVMAdminKrajGreska() {
        super();
