...
/**
 * Servlet implementation class PrikazKorAdmin
 */
@WebServlet("/PrikazKorAdmin")
public class PrikazKorAdmin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrikazKorAdmin() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!k.admin.equals("admin") || !k.korisnik.getUloga().equals("admin")){
		  ...
		  out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"style.css\">");
			...
			out.println("		<tr>");
			out.println("			<td><a href=PrikazKorDetaljiAdmin?email=" +kor.getEmail()+">" + kor.getIme() + "</a></td>");
