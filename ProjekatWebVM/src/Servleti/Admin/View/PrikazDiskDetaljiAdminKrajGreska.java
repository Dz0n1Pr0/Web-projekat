...
/**
 * Servlet implementation class PrikazDiskDetaljiAdminKrajGreska
 */
@WebServlet("/PrikazDiskDetaljiAdminKrajGreska")
public class PrikazDiskDetaljiAdminKrajGreska extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrikazDiskDetaljiAdminKrajGreska() {
        super();
