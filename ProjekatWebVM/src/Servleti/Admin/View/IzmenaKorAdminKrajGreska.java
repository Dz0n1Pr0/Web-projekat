...
/**
 * Servlet implementation class IzmenaKorAdminKrajGreska
 */
@WebServlet("/IzmenaKorAdminKrajGreska")
public class IzmenaKorAdminKrajGreska extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IzmenaKorAdminKrajGreska() {
        super();
